...
const New = () => {
    ...
    const newJSX =
        <div className="new__form">
            <label className="new__form--label" htmlFor="destination">Destination:</label>
            <InputBox label={"destination"} placeholder={"the Destination city"} />
            <br />

            <label className="new__form--label" htmlFor="country">Country:</label>
            <InputBox label={"country"}  />
            <br />

            <label className="new__form--label" htmlFor="created by">User name:</label>
            <InputBox label={"created by"} placeholder={"name..."} />
            <br />

            <label className="new__form--label" htmlFor="route">Route:</label>
            ...
            <label className="new__form--label" htmlFor="note">Note:</label>
            <InputBox label={"note"} placeholder={"note..."} />
            <br />

            <button className="new__form--button" type="submit" onClick={handleSubmit} >CREATE</button>
